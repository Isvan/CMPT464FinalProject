...
def cnn_model_fn(features, labels, mode):
    ...
    eval_metrics_ops = {"accuracy": tf.metrics.accuracy(
...
def main(*argv):
    ...
    # load chairs dataset
    imagesTop, imagesFront, imagesSide, labelsTop, labelsFront, labelsSide = chairs_dataset.load(
        56)
    ...
    for view in ["Top", "Front", "Side"]:
        ...
        classifier = tf.estimator.Estimator(
            model_fn=cnn_model_fn, model_dir="checkpoint/"+view+"/")
