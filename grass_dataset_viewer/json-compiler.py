...
"""
This file needs to be placed outside of teh Chair directory, such that it can access it using Chair/*.
Create a folder called Compiled-data, where it will place all the data
"""
